...
public class Problem1181 {
    ...
    public static void main(String[] args) {
        List<String> ansList = new Problem1181().beforeAndAfterPuzzles(new String[]{
                "writing code","code rocks"
        });
        PrintUtil.printStringList(ansList);

        List<String> ansList1 = new Problem1181().beforeAndAfterPuzzles(new String[]{
                "mission statement",
                "a quick bite to eat",
        ...
        List<String> ansList2 = new Problem1181().beforeAndAfterPuzzles(new String[]{
                "a","b","a"
        });
