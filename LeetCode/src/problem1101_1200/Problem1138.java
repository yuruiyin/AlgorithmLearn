...
public class Problem1138 {
    ...
    public static void main(String[] args) {
        System.out.println(new Problem1138().alphabetBoardPath("leet"));
        System.out.println(new Problem1138().alphabetBoardPath("code"));
        System.out.println(new Problem1138().alphabetBoardPath("zdz"));
        System.out.println(new Problem1138().alphabetBoardPath("zb"));
    }
