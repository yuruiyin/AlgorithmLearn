...
//        System.out.println(new Problem1183().maximumNumberOfOnes(3,3,2,1));
//        System.out.println(new Problem1183().maximumNumberOfOnes(3,3,2,2));
        System.out.println(new Problem1183().maximumNumberOfOnes(10,10,4,5)); //42
//        System.out.println(new Problem1183().maximumNumberOfOnes(4,4,2,2)); //42
    }
}
