...
public class Problem773_2 {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                for (int neiPos : neighPosArr) {
                    ...
                    queue.add(newBoardFlag + (neiPos << 18));
                }
            }
            ans++;
        }
    ...
    public static void main(String[] args) {
        System.out.println(new Problem773_2().slidingPuzzle(new int[][]{
                {1, 2, 3}, {4, 0, 5}
        }));
    }
