...
public class Problem03 {
    ...
    public static void main(String[] args) {
        System.out.println(new Problem03().knightDialer(1));
        System.out.println(new Problem03().knightDialer(2));
        System.out.println(new Problem03().knightDialer(3));
        System.out.println(new Problem03().knightDialer(4));
        System.out.println(new Problem03().knightDialer(5000));
    }
