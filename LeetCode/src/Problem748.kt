...
fun main(args: Array<String>) {
    println(Problem748().shortestCompletingWord("1s3 PSt", arrayOf("step", "steps", "stripe", "stepple")))
    println(Problem748().shortestCompletingWord("1s3 456", arrayOf("looks", "pest", "stew", "show")))
    println(Problem748().shortestCompletingWord("tR28607", arrayOf("present","fall","make","change","everything","performance","owner","beat","name","serve")))
}