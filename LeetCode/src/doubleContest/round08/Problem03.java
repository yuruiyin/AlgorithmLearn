...
public class Problem03 {
    ...
    public static void main(String[] args) {
        List<Integer> ansList = new Problem03().shortestDistanceColor(new int[]{1,1,2,1,3,2,2,3,3}, new int[][]{
                {1,3},
                {2,2},
                {6,1}
        });
        ...
        List<Integer> ansList1 = new Problem03().shortestDistanceColor(new int[]{1,2}, new int[][]{
                {0,3},
        });
