...
public class D_2 {
    ...
    private int solve(int idx, int time) {
        ...
        return memo[idx][time] = Math.min(solve(idx + 1, time), cost[idx] + solve(idx + 1, time + times[idx]));
    }
    ...
    public static void main(String[] args) {
        System.out.println(new D_2().paintWalls(new int[]{1,2,3,2}, new int[]{1,2,3,2}));
