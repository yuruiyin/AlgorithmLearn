...
public class Problem02 {
    ...
    public static void main(String[] args) {
        System.out.println(new Problem02().longestSubsequence(new int[]{1,2,3,4}, 1));
        System.out.println(new Problem02().longestSubsequence(new int[]{1,3,5,7}, 1));
        System.out.println(new Problem02().longestSubsequence(new int[]{1,5,7,8,5,3,4,2,1}, -2));
        System.out.println(new Problem02().longestSubsequence(new int[]{1,5,7,8,5,3,4,2,1}, -2));
