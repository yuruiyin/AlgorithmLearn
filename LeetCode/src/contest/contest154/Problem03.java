...
//        int[] arr2 = new int[3*n];
    ...
    public static void main(String[] args) {
        System.out.println(new Problem03().kConcatenationMaxSum(new int[]{1,2}, 3));
        System.out.println(new Problem03().kConcatenationMaxSum(new int[]{1,-2,1}, 5));
        System.out.println(new Problem03().kConcatenationMaxSum(new int[]{-1,-2}, 7));
//
        System.out.println(new Problem03().kConcatenationMaxSum(new int[]{-1,2,3,-2}, 3));
    }
}
