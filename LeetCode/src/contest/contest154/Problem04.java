...
public class Problem04 {
    ...
    private ArrayList<Connection>[] pointEdgeList; // 每个点相连的边
    ...
    private void dfs(Set<Long> connectionVisited, Set<Integer> pointVisited, List<Set<Integer>> curPointCircleSetList, int from, int next) {
        ...
        for (Connection connection : pointEdgeList[next]) {
     ...
     * 计算每个节点相连的边
     */
    private void calcPointEdgeList(int n, List<Connection> connections) {
        // 计算每个节点相连的边
    ...
    public List<List<Integer>> criticalConnections(int n, List<List<Integer>> connections) {
        ...
        for (List<Integer> connection : connections) {
            connectionList.add(new Connection(connection.get(0), connection.get(1)));
        }
...
//
//        List<List<Integer>> ansList = new Problem04().criticalConnections(4, connections);
//
//        PrintUtil.printIntListList(ansList); // 1,3
        ...
        List<List<Integer>> ansList1 = new Problem04().criticalConnections(6, connections1);
