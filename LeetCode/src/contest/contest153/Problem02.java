...
public class Problem02 {
    ...
    public static void main(String[] args) {
        System.out.println(new Problem02().dayOfTheWeek(27, 10, 2019));
        System.out.println(new Problem02().dayOfTheWeek(29, 10, 2019));
        System.out.println(new Problem02().dayOfTheWeek(31, 8, 2019));
        System.out.println(new Problem02().dayOfTheWeek(18, 7, 1999));
        System.out.println(new Problem02().dayOfTheWeek(15, 8, 1993));
    }
