...
public class D {
    ...
    private int dfs1(int isPreEqual, int pre, int leftCount, char[] arr) {
        if (leftCount == 0) {
            return 1;
        }
    ...
    private long getAns(char[] arr) {
        ...
        for (int first = 1; first <= arr[0] - '0'; first++) {
            int isPreEqual = first == arr[0] - '0' ? 1 : 0;
    ...
    public static void main(String[] args) {
        System.out.println(new D().countSteppingNumbers("90", "101"));
        System.out.println(new D().countSteppingNumbers("2", "40"));
        System.out.println(new D().countSteppingNumbers("106", "121"));
    }
