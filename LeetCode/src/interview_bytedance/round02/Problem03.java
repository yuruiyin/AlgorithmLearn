...
public class Problem03 {
    ...
    public static void main(String[] args) {
        System.out.println(new Problem03().nearestPalindromic("123"));
        System.out.println(new Problem03().nearestPalindromic("121"));
        System.out.println(new Problem03().nearestPalindromic("101"));
        System.out.println(new Problem03().nearestPalindromic("100"));
        System.out.println(new Problem03().nearestPalindromic("10"));
        System.out.println(new Problem03().nearestPalindromic("1000"));
        System.out.println(new Problem03().nearestPalindromic("99"));
        System.out.println(new Problem03().nearestPalindromic("1998"));
        System.out.println(new Problem03().nearestPalindromic("1999"));
        System.out.println(new Problem03().nearestPalindromic("1283"));
        System.out.println(new Problem03().nearestPalindromic("19999"));
        System.out.println(new Problem03().nearestPalindromic("12389"));
        System.out.println(new Problem03().nearestPalindromic("11911"));
        System.out.println(new Problem03().nearestPalindromic("1837722381"));
