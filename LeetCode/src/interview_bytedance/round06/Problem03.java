...
public class Problem03 {
    ...
    public static void main(String[] args) {
        System.out.println(new Problem03().firstUniqChar("leetcode"));
        System.out.println(new Problem03().firstUniqChar("loveleetcode"));
        System.out.println(new Problem03().firstUniqChar("lleettccoodde"));
    }
